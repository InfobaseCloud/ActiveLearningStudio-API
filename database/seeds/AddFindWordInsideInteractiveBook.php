...
class AddFindWordInsideInteractiveBook extends Seeder
{
    /**
    ...
    {
        //H5P.Column.1-13
        $h5pFindWordLibParams = ['name' => "H5P.Column", "major_version" => 1, "minor_version" => 13];
        ...
        //H5P.Column.1-12
        $h5pFindWordTwoLibParams = ['name' => "H5P.Column", "major_version" => 1, "minor_version" => 12];
        $h5pFindWordTwoLib = DB::table('h5p_libraries')->where($h5pFindWordTwoLibParams)->first();
        if ($h5pFindWordTwoLib) {
            DB::table('h5p_libraries')->where($h5pFindWordTwoLibParams)->update([
                'semantics' => $this->updatedSemanticsTwo()
            ]);
        }
    }
    ...
    //H5P.Column.1-12
    private function updatedSemanticsTwo() { 
        return '[
            {
              "name": "content",
              "label": "List of Column Content",
